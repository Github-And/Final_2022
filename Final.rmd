...
Shown above is the effectiveness confidence interval for males. If the interval isn't above 50%, then that means the vaccine is not effective in protecting males against COVID-19. The confidence level is shown as `r round(low, digits = 2)`  to `r round(hi, digits = 2)` meaning the vaccine is a success for males. To measure how effective the vaccine is on males, we use the odds ratio. The odds ratio here is listed as `r effectivenessmale` meaning it is effective.
